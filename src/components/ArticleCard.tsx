...
type ArticleCardProps = {
  ...
  lead?: boolean;
  mobileImagePlacement?: "thumbnail" | "belowText";
...
export function ArticleCard({
  article,
  lead = false,
  mobileImagePlacement = "thumbnail",
  ...
  const image =
    typeof article.heroImage === "object" && article.heroImage
      ? article.heroImage
      : null;
  const showImageBelowText =
    !lead && showMobileImage && mobileImagePlacement === "belowText";
  ...
  const mediaClass = lead
    ...
    : showImageBelowText
      ? "mt-4 sm:col-auto sm:row-auto sm:mt-4 sm:block"
      : showMobileImage
  ...
  const metaClass = lead
    ...
    : showImageBelowText
      ? "mt-3 font-ui text-[0.68rem] uppercase leading-5 tracking-[0.12em] text-[var(--muted)] sm:mt-4 sm:text-xs sm:tracking-[0.14em]"
            ...
            <Image
              ...
              sizes={
                lead
                  ...
                  : showImageBelowText
                    ? "(max-width: 639px) calc(100vw - 42px), (min-width: 768px) 33vw, 100vw"
